...
SoundBuffer* SoundBuffer::s_pInstance = 0;

ALuint SoundBuffer::addSoundEffect(const char* filename) noexcept
{
    ALenum err, format;
    ALuint buffer;
    SNDFILE* sndfile;
...
bool SoundBuffer::removeSoundEffect(const ALuint& buffer) noexcept
{
