...
bool PlayState::onEnter()
{
    ...
    TextureManager::Instance()->load("assets/images/bullet1.png", "bullet1", Game::Instance()->getRenderer());
    TextureManager::Instance()->load("assets/images/bullet2.png", "bullet2", Game::Instance()->getRenderer());
    TextureManager::Instance()->load("assets/images/bullet3.png", "bullet3", Game::Instance()->getRenderer());
    TextureManager::Instance()->load("assets/images/lives.png", "lives", Game::Instance()->getRenderer());
